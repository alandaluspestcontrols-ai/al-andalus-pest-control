...
export default function FixedContactButtons() {
  return (
    <div className="fixed bottom-4 right-4 md:bottom-6 md:right-6 z-50 flex flex-col gap-3 md:gap-4">
      {/* WhatsApp Button */}
      <a
        href="https://wa.me/971502765910"
        target="_blank"
        rel="noopener noreferrer"
        className="group bg-[#25D366] hover:bg-[#20BA5A] text-white rounded-full p-3 md:p-4 shadow-2xl hover:shadow-3xl transition-all transform hover:scale-110 active:scale-95 flex items-center justify-center size-14"
